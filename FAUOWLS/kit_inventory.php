    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Kits Inventory Movements</h1>

           <div class="row placeholders">
              <div class="col-xs-6 col-sm-3 placeholder">
			  <form action="kit_inventory_process.php" method="post">
...
$resultSet = $mysqli->query("select k.item, k.input, i.location_in_lab, k.quantity as kqty, i.quantity as iqty from Kits k inner join Inventory i on i.perry_part_num=k.input where '$id' = k.item;");
